...
describe('Test directory caching', () => {
    class TestDirectory extends MemoryDirectory {
        ...
        getFile(pathArray) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                this.callCount++;
                return _super.getFile.call(this, pathArray);
            });
        }
        getChildren() {
            const _super = Object.create(null, {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                this.callCount++;
                return _super.getChildren.call(this);
            });
        }
    }
    test('new directories cached', () => __awaiter(this, void 0, void 0, function* () {
        let root = new TestDirectory(null, "root");
        let rootCache = new CachedProxyRootDirectory(root);
        let dir1 = yield rootCache.addDirectory("test1");
        let dir2 = yield rootCache.addDirectory("test2");
        let children = yield rootCache.getChildren();
        expect(children.length).toEqual(2);
        expect(root.callCount).toEqual(1); // Nothing should be cached the first time.
        // Reset call count
        root.callCount = 0;
        children = yield rootCache.getChildren();
        expect(children.length).toEqual(2);
        expect(root.callCount).toEqual(0); // Should be cached the second time.
        let file = yield rootCache.getFile([dir1.name]);
...
class MockRemoteRequester {
    constructor(rootDirectory) {
        this.rootDirectory = rootDirectory;
    }
    getChildById(directory, id) {
