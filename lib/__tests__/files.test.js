...
const index_1 = __importDefault(require("fake-indexeddb/build/index"));
...
function testStorage(rootDirectory) {
    ...
    test('change listener', () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(dir1 instanceof node_1.NodeDirectory)) {
...
global.window.indexedDB = index_1.default;
