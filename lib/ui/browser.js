...
class FileTableData extends table_1.AbstractTableData {
    constructor() {
        super();
    ...
    set data(value) {
        ...
        if (this.file !== null) {
            ...
            else if (this.file instanceof base_1.Directory) {
...
exports.FileTableData = FileTableData;
class PathTableData extends table_1.AbstractTableData {
    get data() {
...
exports.PathTableData = PathTableData;
...
class FileBrowser extends element_1.CustomElement {
    constructor() {
        ...
        this.ondblclick = (event) => {
            ...
            let fileRow = utils_1.getFirstInPath(event, table_1.Row);
            if (fileRow !== null) {
        ...
        this.cachedCurrentDirectory = new proxy_1.CachedProxyDirectory(new virtual_1.VirtualFS(new memory_1.MemoryDirectory(null, 'root')));
    }
    ...
    onFileRowDoubleClick(row) {
        let rowData = this.getRowDataFromRow(row);
        if (rowData.file !== null) {
            if (rowData.file instanceof base_1.Directory) {
