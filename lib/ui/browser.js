...
import { AbstractTableData, Row, Table } from "elements/lib/table.js";
...
export class PathTableData extends AbstractTableData {
    get data() {
        return this.innerText.split('/').map((segment) => {
            return decodeURIComponent(segment);
        });
    }
    set data(value) {
        this.innerText = value.map((segment) => {
...
export class FileBrowser extends CustomElement {
    ...
    copyUrl(url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let buffer = yield fileToArrayBuffer(blob);
