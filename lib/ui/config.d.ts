 ...
 */
export declare function parseConfigFile(data: ArrayBuffer): ConfigData;
/**
 ...
 */
export declare function updateConfigFile(newConfig: ConfigData, data?: ArrayBuffer): Promise<ArrayBuffer>;
