...
class RemoteFile extends files.BasicFile {
    constructor(parent, fileData, apiUrl, requester) {
        super();
        this.extra = {};
        this.parent = parent;
    ...
    write(data) {
        return __awaiter(this, void 0, void 0, function* () {
            let buf = yield this.requester.request(this.urlObject, {}, new Blob([data], { type: this.mimeType }), 'POST');
...
class RemoteDirectory extends files.Directory {
    ...
    read() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.requester.request(this.urlObject, {}, null, 'GET');
        });
    }
    rename(newName) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    search(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let responseData = yield this.requester.request(this.urlObject, {}, formData, 'POST');
