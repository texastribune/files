...
class RemoteFile extends files.BasicFile {
    ...
    write(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ajax(new URL(this.url, this.apiUrl), {}, new Blob([data], { type: this.mimeType }), 'POST');
        });
    }
    rename(newName) {
        return __awaiter(this, void 0, void 0, function* () {
...
class RemoteDirectory extends files.Directory {
    ...
    search(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let responseData = yield ajax(new URL(this.url, this.apiUrl), {}, formData, 'POST');
