...
class FileTableRow extends table_1.Row {
    ...
    createNameColumn() {
        let column = document.createElement('table-data');
        if (this.file !== null) {
...
class FileBrowser extends element_1.CustomElement {
    constructor() {
        ...
        this.searchIcon = utils_1.createNode(icons.searchIcon);
    ...
    get path() {
        return this.currentDirectory.path.slice(1).map((directory) => {
    ...
    get css() {
        ...
        selectable-table.${FileBrowser.activeAjaxClass} > div {
          display: block;
        }
    ...
    render(shadowRoot) {
        ...
        shadowRoot.appendChild(this.table);
    ...
    loadingWrapper(promise) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log("ADD");
            this.table.classList.add(FileBrowser.activeAjaxClass);
            try {
                return yield promise;
            }
            finally {
                this.table.classList.remove(FileBrowser.activeAjaxClass);
                console.log("REMOVE");
            }
        });
    }
    ...
    search(searchTerm) {
        return __awaiter(this, void 0, void 0, function* () {
            this.clearMessages();
            if (searchTerm) {
                yield this.loadingWrapper(this.currentDirectory.search(searchTerm).then((searchResults) => {
