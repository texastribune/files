...
class FileBrowser extends element_1.CustomElement {
    ...
    search(searchTerm) {
        return __awaiter(this, void 0, void 0, function* () {
            this.clearMessages();
            if (searchTerm) {
                yield this.loadingWrapper((() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield this.setTableData(searchResults);
                }))());
            }
            else {
                yield this.loadingWrapper(this.resetFiles());
            }
        });
    }
                    ...
                    if (selectedFile.mimeType === 'application/javascript') {
                        ...
                        runButton.onclick = () => {
                            this.errorLoggingWrapper((() => __awaiter(this, void 0, void 0, function* () {
                                yield this.currentDirectory.execPath(selectedRow.path);
                            }))());
                        };
...
FileBrowser.buttonClass = 'dropdown-menu button';
