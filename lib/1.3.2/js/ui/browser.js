import { FileNotFoundError } from "../files/base";
import { convertBytesToReadable, fileToArrayBuffer } from "../utils";
import * as icons from './icons.js';
import { parseConfigFile } from "./config";
import { updateConfigFile } from "./config";
import { ConfirmDialog, Dialog } from "elements/lib/dialog";
import { Table, Row } from "elements/lib/table";
...
export class FileBrowser extends CustomElement {
    constructor() {
        ...
        this.history = document.createElement('bread-crumbs');
        ...
        // Context menu
        this.contextMenu = document.createElement('base-dialog');
    ...
    set path(path) {
        this.busy = this.busy
            .then(() => {
            return this.logAndLoadWrapper(this.rootDirectory.getFile(path)
                .then((newDirectory) => {
            ...
            if (selectedFileRows.length === 1) {
                ...
                if (selectedFile !== null) {
                    ...
                    if (selectedFile.mimeType === 'application/javascript') {
                        ...
                        runButton.onclick = () => {
                            this.errorLoggingWrapper((async () => {
...
FileBrowser.contextMenuClass = 'file-browser-context-menu';
