...
class FileBrowser extends element_1.CustomElement {
    constructor() {
        ...
        this.cachedRootDirectory = new proxy_1.CachedProxyDirectory(new memory_1.MemoryDirectory(null, 'root'));
    ...
    set rootDirectory(value) {
        ...
        this.cachedRootDirectory = new proxy_1.CachedProxyDirectory(value);
        this.cachedCurrentDirectory = this.cachedRootDirectory;
        this.refreshFiles();
    }
    /**
