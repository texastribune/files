...
class RemoteFile extends files.BasicFile {
    ...
    copy(targetDirectory) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _super.copy.call(this, targetDirectory);
        });
    }
    move(targetDirectory) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _super.move.call(this, targetDirectory);
        });
    }
}
class RemoteDirectory extends files.Directory {
    ...
    search(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let data = yield file.write(utils_1.stringToArrayBuffer(query));
    ...
    addFile(fileData, filename, mimeType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new RemoteFile(this, utils_1.parseJsonArrayBuffer(newData), this.apiUrl);
        });
    }
    addDirectory(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new RemoteDirectory(this, utils_1.parseJsonArrayBuffer(newData), this.apiUrl);
        });
    }
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
