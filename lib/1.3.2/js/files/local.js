        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (e.name === "ConstraintError") {
                    throw new base_1.FileAlreadyExistsError(`file named ${unSavedFileData.name} already exists`);
                }
    ...
    update(id, updateFields) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (e.name === "ConstraintError") {
                    throw new base_1.FileAlreadyExistsError(`file named ${fileData.name} already exists`);
                }
...
exports.database = new FileStore('db', 'files');
/**
...
class LocalStorageFile extends files.BasicFile {
    ...
    addOnChangeListener(listener) {
        ...
        exports.database.addOnFilesChangedListener(databaseListener);
    }
    removeOnChangeListener(listener) {
        let databaseListener = this.listenerMap.get(listener);
        if (databaseListener !== undefined) {
            exports.database.removeOnFilesChangedListener(databaseListener);
            this.listenerMap.delete(listener);
        }
    }
    read(params) {
        return __awaiter(this, void 0, void 0, function* () {
            let fileData = yield exports.database.get(this.intId);
            return fileData.file || new ArrayBuffer(0);
        });
    }
    write(data) {
        return __awaiter(this, void 0, void 0, function* () {
            let fileData = yield exports.database.update(this.intId, { file: data });
    ...
    rename(newName) {
        return __awaiter(this, void 0, void 0, function* () {
            let fileData = yield exports.database.update(this.intId, { name: newName });
            this._name = fileData.name;
        });
    }
    delete() {
        return __awaiter(this, void 0, void 0, function* () {
            yield exports.database.delete(this.intId);
        });
    }
    copy(targetDirectory) {
        return __awaiter(this, void 0, void 0, function* () {
            if (targetDirectory instanceof LocalStorageDirectory) {
                yield exports.database.copy(this.intId, targetDirectory.intId);
            }
        });
    }
    move(targetDirectory) {
        return __awaiter(this, void 0, void 0, function* () {
            if (targetDirectory instanceof LocalStorageDirectory) {
                yield exports.database.move(this.intId, targetDirectory.intId);
            }
        });
    }
}
...
class LocalStorageDirectory extends files.Directory {
    ...
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            let children = [];
            let childDataArray = yield exports.database.getChildren(this.intId);
    ...
    addFile(file, name, mimeType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let fileData = yield exports.database.add(this.intId, name, file, mimeType);
            return new LocalStorageFile(fileData);
        });
    }
    addDirectory(name) {
        return __awaiter(this, void 0, void 0, function* () {
            let fileData = yield exports.database.add(this.intId, name, null, files.Directory.mimeType);
