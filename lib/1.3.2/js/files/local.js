...
class FileStore extends Database {
    ...
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield indexedDbRequestToPromise(transaction.objectStore(this.objectStoreName).get(parseInt(id)));
            }
            catch (e) {
    ...
    update(id, updateFields) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let fileData;
            try {
                fileData = yield indexedDbRequestToPromise(transaction.objectStore(this.objectStoreName).get(parseInt(id)));
            }
            catch (e) {
                throw new files.FileNotFoundError(`Could not find file with id ${id}.`);
            }
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let existing;
            try {
                existing = yield indexedDbRequestToPromise(transaction.objectStore(this.objectStoreName).get(parseInt(id)));
