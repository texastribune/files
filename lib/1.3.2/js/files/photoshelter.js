...
exports.PhotoshelterAPI = PhotoshelterAPI;
class PhotoshelterImage extends files.BasicFile {
...
exports.PhotoshelterImage = PhotoshelterImage;
class PhotoshelterCollection extends files.Directory {
    constructor(data, api) {
        super();
        this.icon = null;
        this.extra = {};
...
exports.PhotoshelterCollection = PhotoshelterCollection;
class PhotoshelterGallery extends files.Directory {
    constructor(data, api) {
        super();
        this.icon = null;
        this.extra = {};
...
exports.PhotoshelterGallery = PhotoshelterGallery;
