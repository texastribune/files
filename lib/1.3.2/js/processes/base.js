...
class Process extends files_js_1.ProcessFile {
    constructor(parentProcess, workingDirectory, executablePathArray, stdout, stderr) {
        ...
        this.worker.onmessage = (event) => {
            ...
            if (func) {
                func(...args)
                    ...
                    .catch((error) => {
                    let buffer = utils_js_1.stringToArrayBuffer(`System error: ${error}`);
                    this.onExit();
        ...
        this.workingDirectory.getFile(this.executablePath)
            ...
            .catch((error) => {
            let buffer = utils_js_1.stringToArrayBuffer(`File ${this.executableName} could not be executed: ${error}`);
            this.onExit();
            return this.stderr.write(buffer);
        });
    }
    ...
    get systemCalls() {
        ...
        return {
            import: (pathArray, variableName) => __awaiter(this, void 0, void 0, function* () {
                ...
                let scriptString = yield file.readText();
                try {
            ...
            exit: (message) => __awaiter(this, void 0, void 0, function* () {
                let buffer = utils_js_1.stringToArrayBuffer(message);
                yield this.stdout.write(buffer);
                this.onExit();
            }),
            error: (message) => __awaiter(this, void 0, void 0, function* () {
                let buffer = utils_js_1.stringToArrayBuffer(`The process ${this.name} returned an error: ${message}`);
