...
describe('Test memory file storage', () => {
    ...
    beforeEach(() => {
        storage = new memory_1.MemoryDirectory(null, 'root');
    });
    testStorage(storage);
});
...
describe('Test virtual file storage', () => {
    ...
    let storage = new virtual_1.VirtualDirectory(rootMounted);
    beforeEach(() => __awaiter(this, void 0, void 0, function* () {
        rootMounted = new memory_1.MemoryDirectory(null, 'mounted');
        storage = new virtual_1.VirtualDirectory(rootMounted);
    }));
    testStorage(storage);
});
